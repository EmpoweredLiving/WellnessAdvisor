...
import 'settings_notification_model.dart';
export 'settings_notification_model.dart';

class SettingsNotificationWidget extends StatefulWidget {
  const SettingsNotificationWidget({super.key});

  static String routeName = 'SettingsNotification';
  static String routePath = '/settingsNotification';
...
class _SettingsNotificationWidgetState
  ...
  late SettingsNotificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SettingsNotificationModel());
