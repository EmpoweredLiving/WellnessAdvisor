...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF93B7B6);
  late Color secondary = const Color(0xFF004443);
  late Color tertiary = const Color(0xFFE2D7CA);
  late Color alternate = const Color(0xFFC9B99A);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFFFFFFFF);
  late Color primaryBackground = const Color(0xFFFFFDF9);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x7C027464);
  late Color accent2 = const Color(0xD939D2C0);
